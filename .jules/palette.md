...
## 2024-05-25 - Semantic Interactive Elements
**Learning:** Non-semantic clickable elements (like div or p) exclude keyboard users and lack clear accessibility semantics.
**Action:** Refactor clickable elements representing user profiles into semantic <button> elements with type="button" and descriptive aria-labels.

  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      ...
      <button
        ...
        className="cursor-pointer hover:drop-shadow-md transition focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 dark:focus-visible:ring-zinc-400 focus-visible:ring-offset-2 rounded-full"
        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2">
            ...
            <button
              type="button"
              onClick={onMemberClick}
              className="font-semibold text-sm hover:underline cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 dark:focus-visible:ring-zinc-400 focus-visible:ring-offset-2 rounded-sm"
              aria-label={`Посмотреть профиль пользователя ${member.profile.name}`}
            >
                {member.profile.name}
              </button>

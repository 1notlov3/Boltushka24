  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      ...
      <button
        ...
        className="cursor-pointer hover:drop-shadow-md transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-full"
        aria-label="Посмотреть профиль пользователя"
        type="button"
      >
        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2">
            ...
            <button
              onClick={onMemberClick}
              className="font-semibold text-sm hover:underline cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-sm"
              aria-label="Посмотреть профиль пользователя"
              type="button"
            >
                {member.profile.name}

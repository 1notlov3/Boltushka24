            ...
            <p onClick={onMemberClick} className="font-semibold text-sm hover:underline cursor-pointer">
              ...
              {roleIconMap[member.role] && (
                <ActionTooltip label={roleNameMap[member.role]}>
                  <span tabIndex={0} role="img" aria-label={roleNameMap[member.role]} className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-sm">
                    {roleIconMap[member.role]}
                  </span>
                </ActionTooltip>
              )}

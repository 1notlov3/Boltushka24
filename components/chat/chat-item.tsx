  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
      ...
      <button
        ...
        className="cursor-pointer hover:drop-shadow-md transition focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-full"
      >
        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2">
            ...
            <button
              ...
              onClick={onMemberClick}
              aria-label={`Посмотреть профиль пользователя ${member.profile.name}`}
              className="font-semibold text-sm hover:underline cursor-pointer focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-sm"
            >
                {member.profile.name}
              </button>
              {roleIconMap[member.role] && (
                <ActionTooltip label={roleNameMap[member.role]}>
                  <span tabIndex={0} role="img" aria-label={roleNameMap[member.role]} className="focus-visible:ring-2 focus-visible:ring-zinc-500 rounded-sm outline-none">
                    {roleIconMap[member.role]}
                  </span>
                </ActionTooltip>
              )}
